...
//   [key in SubscriptionTier]: ProratedPrice;
// };
...
//             {option.tier !== currentTier &&
//               prorationDetails &&
//               prorationDetails[option.tier] && (
//                 <div className="mt-2 text-sm">
//                   <p>
//                     Prorated amount: $
//                     {prorationDetails[option.tier].newAmount}
//                   </p>
//                   <p>
//                     New monthly rate: $
...
const UpdateTierModal = () => {
  return <div>UpdateTierModal</div>;
};
