      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-3 rtl:space-x-reverse">
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg md:hidden hover:border hover:border-white focus:outline-none focus:ring-1 focus:ring-white0"
