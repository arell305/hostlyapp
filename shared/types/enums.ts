...
export type SubscriptionTier = "Standard" | "Plus" | "Elite";

export type ResponseStatus = "success" | "error" | "partial success";
...
export type StripePaymentType = "card";

export const subscriptionBenefits = {
  Standard: "Unlimited tickets",
  Plus: `Unlimited tickets & ${PLUS_GUEST_LIST_LIMIT} guest lists`,
  Elite: "Unlimited tickets & guest lists",
...
// ──────────────────────────────────────────────────────────────
// Error Message Objects (no enum needed)
// ──────────────────────────────────────────────────────────────
...
export const ErrorMessages = {
  ...
  CLERK_WEBHOOK_ORG_INV_ACCEPTED:
    "Clerk Error handling organizationInvitation.accepted",
  ...
  CLERK_WEBHOOK_UPDATED_USER_NO_EMAIL:
    "User updated event received without an email",
  ...
  CONNECTED_ACCOUNT_DEACTIVATE_ERROR:
    "Stripe Connected Account deactivate error",
  CONNECTED_ACCOUNT_NOT_FOUND: "Stripe Connected Account not found",
  CONNECTED_ACCOUNT_UPDATE_ERROR:
    "Stripe Connected Account update or create error",
  CONNECTED_ACCOUNT_DB_QUERY_BY_CLERK:
    "DB error query connected account by clerk id",
  CONNECTED_ACCOUNT_DB_UPDATE_BY_STRIPE:
    "DB error query connected account by stripe id",
  CONNECTED_ACCOUNT_VERIFICATION: "Connected accound error verifying webhook",
  CONNECTED_ACCOUNT_PAYMENT_INTENT_SUCCEEDED:
    "Connected account error handling payment_intent.succeeded",
  ...
  ENV_NOT_SET_CLERK_SECRET_KEY:
    "CLERK_SECRET_KEY environment variable is not set.",
  ENV_NOT_SET_CLERK_WEBHOOK:
    "CLERK_WEBHOOK_SECRET environmental variable not set",
  ENV_NOT_SET_NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY:
    "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY environment variable is not set.",
  ENV_NOT_SET_NEXT_PUBLIC_CONVEX_URL:
    "NEXT_PUBLIC_CONVEX_URL environment variable is not set.",
  ENV_NOT_SET_NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY:
  ...
  ENV_NOT_SET_STRIPE_PLATFORM_WEBHOOKS_SECRET:
    "Missing STRIPE_PLATFORM_WEBHOOKS_SECRET",
  ENV_NOT_SET_CLERK_ISSUER_DOMAIN:
    "Missing CLERK_ISSUER_DOMAIN environment variable",
  ENV_NOT_SET_CONNECTED: "Missing STRIPE_CONNECTED_WEBHOOK_SECRET",
  ENV_NOT_SET_PDF_MONKEY:
    "Missing PDFMONKEY_WEBHOOK_SECRET environment variable",
  ...
  ORGANIZATION_FACTOR_QUERY_NAME_ERROR:
    "DB error fetching organization by name",
  ...
  PROMOTER_NOT_BELONG_TO_COMPANY_OF_EVENT:
    "Promoter does not belong to company of event",
  ...
  STRIPE_CANCEL_PERIOD_END_ERROR:
    "Stripe error canceling subscription at period end",
  STRIPE_CONNECT_CREATE_ERROR: "Stripe connect error creating account",
  STRIPE_CONNECT_DASHBOARD_ERROR:
    "Stripe connect error creating dashboard link",
  STRIPE_CONNECT_ONBOARDING_ERROR:
    "Stripe connect error creating onboarding session",
  ...
  TICKET_INFO_DB_QUERY_BY_EVENT_ID_ERROR:
    "DB error query ticket info by event Id.",
  ...
  CUSTOMER_EXISTING_USER:
    "Existing user with that email already exists. Please use a different email",
  INTERNAL_ERROR: "Internal Error:",
  SUBSCRIPTION_DB_QUERY_BY_CUSTOMER:
    "DB error query subscription by customerId",
  ...
  STRIPE_PAYMENT_INTENT_SUCCEEDED:
    "Stripe error handling payment_intent.succeeded",
  ...
  CONTEXT_ORGANIZATION_PROVER:
    "useOrganizationContext must be used within a OrganizationProvider",
  CONTEXT_PUBLIC_ORGANIZATION_PROVIDER:
    "useContextPublicOrganization must be used within a PublicOrganizationProvider",
  DATE_BEFORE_SUBSCRIPTION:
    "The provided date is before the subscription start date.",
  ...
  STRIPE_SUBSCRIPTION_UPDATED:
    "Stripe webhook error handling customer.subscription.updated",
  STRIPE_SUBSCRIPTION_DELETED:
    "Stripe webhook error handling customer.subscription.delete",
  ...
  STRIPE_PAYMENT_INTENT_ID_NOT_FOUND:
    "Stripe payment intent id not found in checkout",
  ...
  PDF_MONKEY_MISSING_API_KEY:
    "Missing PDFMonkey API Key. Please set PDFMONKEY_API_KEY in your environment variables.",
  PDF_MONKEY_NO_DOWNLOAD_URL:
    "No download URL provided for the generated document.",
  PDF_MONKEY_DOCUMENT_SUCCESS:
    "PDF Monkey webhooker error handling documents.generation.success",
  ...
  STRIPE_SUBSCRIPTION_NOT_FOUND:
    "Stripe Subscription not found or has no items.",
  ...
  STRIPE_CONNECTED_CUSTOMER_DB_QUERY:
    "DB error querying stripe connected customer",
  STRIPE_CONNECTED_CUSTOMER_DB_INSERT:
    "DB error inserting stripe connected customer",
  ...
  GUEST_LIST_CREDIT_TRANSACTION_CREATE_ERROR:
    "DB error creating guest list credit transaction",
  ...
  EVENT_TICKET_TYPES_DB_QUERY_BY_EVENT_ID_ERROR:
    "DB error querying event ticket types by event id",
  ...
  CONTEXT_USER_TEMPLATE_PROVIDER:
    "useContextUserTemplate must be used within a UserTemplateProvider",
} as const;
...
export const ShowErrorMessages = {
  ...
  GUEST_LIST_LIMIT_REACHED:
    "Guest list limit reached for this subscription period.",
  ...
  ACTIVE_SUBSCRIPTION_EXISTS:
    " An active subscription with this email already exists.",
